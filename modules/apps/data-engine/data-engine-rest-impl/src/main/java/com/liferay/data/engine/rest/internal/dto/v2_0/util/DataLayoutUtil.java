	...
	private static DataRule[] _toDataRules(
		...
		for (com.liferay.dynamic.data.mapping.form.builder.converter.model.
			...
			for (DDMFormRuleAction ddmFormRuleAction :
				...
				dataRuleActions = ArrayUtil.append(
					dataRuleActions,
					gson.fromJson(
			...
			dataRule.setActions(dataRuleActions);

			Map[] dataRuleConditions = new Map[0];

			for (DDMFormRuleCondition ddmFormRuleCondition :
					ddmFormRule.getDDMFormRuleConditions()) {

				dataRuleConditions = ArrayUtil.append(
					dataRuleConditions,
					gson.fromJson(
			...
			dataRule.setConditions(dataRuleConditions);
