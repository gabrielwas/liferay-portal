...
public class DataEngineNativeObjectConsumer {
	...
	public void createDataEngineNativeObject(
		...
		System.out.println("-------------------------- After take company");
		...
		System.out.println("-------------------------- Before Post/Put");

		if (Validator.isNull(dataDefinition.getId())) {
			System.out.println("-------------------------- New Native");
		...
		System.out.println("-------------------------- After Create Native");
	}
	...
	private DataDefinitionField[] FIELDSTESTS() {
		List<DataDefinitionField> fieldsTest = new ArrayList<>();

		DataDefinitionField dataDefinitionFieldTest = new DataDefinitionField() {
			{
				customProperties = HashMapBuilder.<String, Object>put(
					"fieldNamespace", StringPool.BLANK
				).put(
		...
		dataDefinitionFieldTest.setFieldType("text");
		dataDefinitionFieldTest.setRequired(false);

		fieldsTest.add(dataDefinitionFieldTest);

		return fieldsTest.toArray(new DataDefinitionField[0]);
	}
