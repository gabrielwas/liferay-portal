...
public class DataEngineNativeObjectObserver {
	...
	public void createDataEngineNativeObject(
		...
		System.out.println(
			StringBundler.concat(
				...
				" NatObj: ", dataEngineNativeObject.getName()));
		...
		System.out.println("-------------------------- After Post/Put");
	}
	...
	private DataDefinitionField[] _fIELDSTESTS() {
		List<DataDefinitionField> fieldsTest = new ArrayList<>();

		DataDefinitionField dataDefinitionFieldTest =
			new DataDefinitionField() {
				{
					...
					label = HashMapBuilder.<String, Object>put(
						"en_US",
						GetterUtil.getString("fieldTeste", "fieldTeste")
					).build();
					localizable = true;
					name = "fieldTeste";
