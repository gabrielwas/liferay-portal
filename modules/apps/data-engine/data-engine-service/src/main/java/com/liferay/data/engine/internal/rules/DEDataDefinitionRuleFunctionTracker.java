...
public class DEDataDefinitionRuleFunctionTracker {
	...
	protected void removeDEDataDefinitionRuleFunction(
		...
		DEDataDefinitionRuleFunction removedDEDataDefinitionRuleFunction =
			_deDataDefinitionRuleFunctions.remove(name);
		...
		deDataDefinitionRuleFunctions.remove(
			removedDEDataDefinitionRuleFunction);
