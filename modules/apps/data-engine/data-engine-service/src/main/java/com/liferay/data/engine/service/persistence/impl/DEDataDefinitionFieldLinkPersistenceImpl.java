...
public class DEDataDefinitionFieldLinkPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByC_C_D;
	private FinderPath _finderPathWithoutPaginationFindByC_C_D;
	private FinderPath _finderPathCountByC_C_D;

	/**
	 * Returns all the de data definition field links where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<DEDataDefinitionFieldLink> findByC_C_D(
		long classNameId, long classPK, long ddmStructureId) {

		return findByC_C_D(
			classNameId, classPK, ddmStructureId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the de data definition field links where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>DEDataDefinitionFieldLinkModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<DEDataDefinitionFieldLink> findByC_C_D(
		long classNameId, long classPK, long ddmStructureId, int start,
		int end) {

		return findByC_C_D(
			classNameId, classPK, ddmStructureId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the de data definition field links where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>DEDataDefinitionFieldLinkModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<DEDataDefinitionFieldLink> findByC_C_D(
		long classNameId, long classPK, long ddmStructureId, int start, int end,
		OrderByComparator<DEDataDefinitionFieldLink> orderByComparator) {

		return findByC_C_D(
			classNameId, classPK, ddmStructureId, start, end, orderByComparator,
			true);
	}
	...
	public List<DEDataDefinitionFieldLink> findByC_C_D(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByC_C_D;
				finderArgs = new Object[] {
			...
			finderPath = _finderPathWithPaginationFindByC_C_D;
			finderArgs = new Object[] {
				classNameId, classPK, ddmStructureId, start, end,
				orderByComparator
			};
		}
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_C_D_CLASSNAMEID_2);

			query.append(_FINDER_COLUMN_C_C_D_CLASSPK_2);

			query.append(_FINDER_COLUMN_C_C_D_DDMSTRUCTUREID_2);
	...
	/**
	 * Returns the first de data definition field link in the ordered set where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param ddmStructureId the ddm structure ID
	 ...
	 */
	@Override
	public DEDataDefinitionFieldLink findByC_C_D_First(
			long classNameId, long classPK, long ddmStructureId,
			OrderByComparator<DEDataDefinitionFieldLink> orderByComparator)
		throws NoSuchDataDefinitionFieldLinkException {
		...
		DEDataDefinitionFieldLink deDataDefinitionFieldLink =
			fetchByC_C_D_First(
				classNameId, classPK, ddmStructureId, orderByComparator);
	 ...
	 */
	@Override
	public DEDataDefinitionFieldLink fetchByC_C_D_First(
		long classNameId, long classPK, long ddmStructureId,
		OrderByComparator<DEDataDefinitionFieldLink> orderByComparator) {

		List<DEDataDefinitionFieldLink> list = findByC_C_D(
			classNameId, classPK, ddmStructureId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last de data definition field link in the ordered set where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param ddmStructureId the ddm structure ID
	 ...
	 */
	@Override
	public DEDataDefinitionFieldLink findByC_C_D_Last(
			long classNameId, long classPK, long ddmStructureId,
			OrderByComparator<DEDataDefinitionFieldLink> orderByComparator)
		throws NoSuchDataDefinitionFieldLinkException {

		DEDataDefinitionFieldLink deDataDefinitionFieldLink = fetchByC_C_D_Last(
			classNameId, classPK, ddmStructureId, orderByComparator);
	 ...
	 */
	@Override
	public DEDataDefinitionFieldLink fetchByC_C_D_Last(
		long classNameId, long classPK, long ddmStructureId,
		OrderByComparator<DEDataDefinitionFieldLink> orderByComparator) {

		int count = countByC_C_D(classNameId, classPK, ddmStructureId);
		...
		List<DEDataDefinitionFieldLink> list = findByC_C_D(
			classNameId, classPK, ddmStructureId, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the de data definition field links before and after the current de data definition field link in the ordered set where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63;.
	 *
	 * @param deDataDefinitionFieldLinkId the primary key of the current de data definition field link
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public DEDataDefinitionFieldLink[] findByC_C_D_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_C_D_PrevAndNext(
				session, deDataDefinitionFieldLink, classNameId, classPK,
				ddmStructureId, orderByComparator, true);

			array[1] = deDataDefinitionFieldLink;

			array[2] = getByC_C_D_PrevAndNext(
				session, deDataDefinitionFieldLink, classNameId, classPK,
				ddmStructureId, orderByComparator, false);
	...
	protected DEDataDefinitionFieldLink getByC_C_D_PrevAndNext(
		Session session, DEDataDefinitionFieldLink deDataDefinitionFieldLink,
		long classNameId, long classPK, long ddmStructureId,
		OrderByComparator<DEDataDefinitionFieldLink> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the de data definition field links where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63; from the database.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param ddmStructureId the ddm structure ID
	...
	/**
	 * Returns the number of de data definition field links where classNameId = &#63; and classPK = &#63; and ddmStructureId = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 * @param ddmStructureId the ddm structure ID
	...
	private static final String _FINDER_COLUMN_C_C_D_CLASSNAMEID_2 =
		"deDataDefinitionFieldLink.classNameId = ? AND ";

	private static final String _FINDER_COLUMN_C_C_D_CLASSPK_2 =
		"deDataDefinitionFieldLink.classPK = ? AND ";

	private static final String _FINDER_COLUMN_C_C_D_DDMSTRUCTUREID_2 =
		"deDataDefinitionFieldLink.ddmStructureId = ?";
	...
	public DEDataDefinitionFieldLink updateImpl(
		...
		if (!_columnBitmaskEnabled) {
			...
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByC_C_D, args);
			...
			if ((deDataDefinitionFieldLinkModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByC_C_D.getColumnBitmask()) !=
					 0) {
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByC_C_D = new FinderPath(
			entityCacheEnabled, finderCacheEnabled,
			DEDataDefinitionFieldLinkImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_C_D",
			new String[] {
		...
		_finderPathWithoutPaginationFindByC_C_D = new FinderPath(
			entityCacheEnabled, finderCacheEnabled,
			DEDataDefinitionFieldLinkImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_C_D",
			new String[] {
