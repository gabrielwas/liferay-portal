...
public class ObjectLayoutServiceHttp {
	...
	public static java.util.List<com.liferay.object.model.ObjectLayout>
		getObjectLayouts(
		...
		try {
			MethodKey methodKey = new MethodKey(
				ObjectLayoutServiceUtil.class, "getObjectLayouts",
				_getObjectLayoutsParameterTypes2);
			...
			return (java.util.List<com.liferay.object.model.ObjectLayout>)
				returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	public static int getObjectLayoutsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				ObjectLayoutServiceUtil.class, "getObjectLayoutsCount",
				_getObjectLayoutsCountParameterTypes3);
	...
	private static final Class<?>[] _getObjectLayoutsParameterTypes2 =
		new Class[] {long.class, int.class, int.class};
	private static final Class<?>[] _getObjectLayoutsCountParameterTypes3 =
		new Class[] {long.class};
