...
public class ObjectLayoutServiceSoap {
	...
	public static com.liferay.object.model.ObjectLayoutSoap[] getObjectLayouts(
			long objectDefinitionId, int start, int end)
		throws RemoteException {

		try {
			java.util.List<com.liferay.object.model.ObjectLayout> returnValue =
				ObjectLayoutServiceUtil.getObjectLayouts(
					objectDefinitionId, start, end);

			return com.liferay.object.model.ObjectLayoutSoap.toSoapModels(
				returnValue);
		}
		catch (Exception exception) {
			_log.error(exception, exception);
	...
	public static int getObjectLayoutsCount(long objectDefinitionId)
		...
		try {
			int returnValue = ObjectLayoutServiceUtil.getObjectLayoutsCount(
				objectDefinitionId);
