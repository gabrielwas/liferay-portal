...
public class DynamicObjectDefinitionTableFactory {
	...
	public static DynamicObjectDefinitionTable
		...
		for (ObjectField objectField : objectFields) {
			...
			String objectRelationshipName = GetterUtil.getString(
			...
			List<String> filters = ObjectFilterUtil.getODataObjectFilters(
	...
	@Reference(unbind = "-")
	private void _setPredicateFactory(PredicateFactory predicateFactory) {
	...
	private static PredicateFactory _predicateFactory;
