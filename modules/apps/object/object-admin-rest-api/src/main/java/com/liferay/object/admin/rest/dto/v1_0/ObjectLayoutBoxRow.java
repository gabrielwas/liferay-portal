 ...
 */
@Generated("")
@GraphQLName("ObjectLayoutBoxRow")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectLayoutBoxRow")
public class ObjectLayoutBoxRow implements Serializable {

	public static ObjectLayoutBoxRow toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectLayoutBoxRow.class, json);
	}
	...
	public String toString() {
		...
		if (objectLayoutBoxColumns != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0; i < objectLayoutBoxColumns.length; i++) {
				sb.append(String.valueOf(objectLayoutBoxColumns[i]));

				if ((i + 1) < objectLayoutBoxColumns.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.liferay.object.admin.rest.dto.v1_0.ObjectLayoutBoxRow",
		name = "x-class-name"
	)
