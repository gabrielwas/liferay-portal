 ...
 */
@Generated("")
@GraphQLName("ObjectLayoutBoxColumn")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectLayoutBoxColumn")
public class ObjectLayoutBoxColumn implements Serializable {

	public static ObjectLayoutBoxColumn toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectLayoutBoxColumn.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.object.admin.rest.dto.v1_0.ObjectLayoutBoxColumn",
		name = "x-class-name"
	)
