...
public interface ObjectDefinitionResource {
	...
	public ObjectDefinition publishObjectDefinition(Long objectDefinitionId)
		throws Exception;

	public HttpInvoker.HttpResponse publishObjectDefinitionHttpResponse(
			Long objectDefinitionId)
		throws Exception;
	...
	public static class ObjectDefinitionResourceImpl
		...
		public ObjectDefinition publishObjectDefinition(Long objectDefinitionId)
			...
			HttpInvoker.HttpResponse httpResponse =
				publishObjectDefinitionHttpResponse(objectDefinitionId);
