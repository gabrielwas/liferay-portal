...
public class CommerceCurrencyLocalServiceImpl
	...
	public CommerceCurrency addCommerceCurrency(
		...
		currencyObjectEntity.setRoundingMode(roundingMode);
	...
	private void _validate(
		...
		if (primary) {
			...
			for (CurrencyObjectEntity currencyObjectEntity :
				...
				if (currencyObjectEntity.getId() != commerceCurrencyId) {
					currencyObjectEntity.setPrimary(false);

					_currencyObjectRepository.updateObjectEntity(
						currencyObjectEntity.getUserId(),
						currencyObjectEntity.getId(), currencyObjectEntity,
						new ServiceContext());
				}
			}
		}
