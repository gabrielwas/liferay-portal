...
/**
 * Provides the local service interface for NotificationAdminTemplate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gabriel Albuquerque
 * @see NotificationAdminTemplateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NotificationAdminTemplateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.notification.admin.service.impl.NotificationAdminTemplateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the notification admin template local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotificationAdminTemplateLocalServiceUtil} if injection and service tracking are not available.
	 */
