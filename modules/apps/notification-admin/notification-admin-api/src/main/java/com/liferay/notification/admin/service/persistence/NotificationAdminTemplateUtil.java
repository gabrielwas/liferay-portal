...
/**
 * The persistence utility for the notification admin template service. This utility wraps <code>com.liferay.notification.admin.service.persistence.impl.NotificationAdminTemplatePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see NotificationAdminTemplatePersistence
 * @generated
 */
public class NotificationAdminTemplateUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(notificationAdminTemplate);
	}
	 ...
	 */
	public static Map<Serializable, NotificationAdminTemplate>
	 ...
	 */
	public static List<NotificationAdminTemplate> findWithDynamicQuery(
	 ...
	 */
	public static NotificationAdminTemplate update(
		NotificationAdminTemplate notificationAdminTemplate) {

		return getPersistence().update(notificationAdminTemplate);
	}
	...
	public static NotificationAdminTemplate update(
		...
		return getPersistence().update(
			notificationAdminTemplate, serviceContext);
	}
	 ...
	 */
	public static List<NotificationAdminTemplate> findByUuid(String uuid) {
	 ...
	 */
	public static List<NotificationAdminTemplate> findByUuid(
	 ...
	 */
	public static NotificationAdminTemplate findByUuid_First(
			String uuid,
			OrderByComparator<NotificationAdminTemplate> orderByComparator)
		throws com.liferay.notification.admin.exception.
			NoSuchNotificationAdminTemplateException {
	 ...
	 */
	public static NotificationAdminTemplate fetchByUuid_First(
		String uuid,
		OrderByComparator<NotificationAdminTemplate> orderByComparator) {
	 ...
	 * @throws NoSuchNotificationAdminTemplateException if a matching notification admin template could not be found
	 */
	public static NotificationAdminTemplate findByUuid_Last(
			String uuid,
			OrderByComparator<NotificationAdminTemplate> orderByComparator)
		throws com.liferay.notification.admin.exception.
			NoSuchNotificationAdminTemplateException {
	 ...
	 */
	public static NotificationAdminTemplate fetchByUuid_Last(
		String uuid,
		OrderByComparator<NotificationAdminTemplate> orderByComparator) {
	 ...
	 */
	public static NotificationAdminTemplate[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			notificationAdminTemplateId, uuid, orderByComparator);
	}
	 ...
	 * @return the matching notification admin templates
	 */
	public static List<NotificationAdminTemplate> findByUuid_C(
	 ...
	 * @throws NoSuchNotificationAdminTemplateException if a matching notification admin template could not be found
	 */
	public static NotificationAdminTemplate findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<NotificationAdminTemplate> orderByComparator)
		throws com.liferay.notification.admin.exception.
			NoSuchNotificationAdminTemplateException {
	 ...
	 * @return the first matching notification admin template, or <code>null</code> if a matching notification admin template could not be found
	 */
	public static NotificationAdminTemplate fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<NotificationAdminTemplate> orderByComparator) {
	 ...
	 * @throws NoSuchNotificationAdminTemplateException if a matching notification admin template could not be found
	 */
	public static NotificationAdminTemplate findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<NotificationAdminTemplate> orderByComparator)
		throws com.liferay.notification.admin.exception.
			NoSuchNotificationAdminTemplateException {
	 ...
	 * @return the last matching notification admin template, or <code>null</code> if a matching notification admin template could not be found
	 */
	public static NotificationAdminTemplate fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<NotificationAdminTemplate> orderByComparator) {
	 ...
	 * @throws NoSuchNotificationAdminTemplateException if a notification admin template with the primary key could not be found
	 */
	public static NotificationAdminTemplate[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			notificationAdminTemplateId, uuid, companyId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(notificationAdminTemplate);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(notificationAdminTemplates);
	}
	 ...
	 */
	public static NotificationAdminTemplate create(
		long notificationAdminTemplateId) {

		return getPersistence().create(notificationAdminTemplateId);
	}
	 ...
	 * @throws NoSuchNotificationAdminTemplateException if a notification admin template with the primary key could not be found
	 */
	public static NotificationAdminTemplate remove(
			long notificationAdminTemplateId)
		throws com.liferay.notification.admin.exception.
			NoSuchNotificationAdminTemplateException {

		return getPersistence().remove(notificationAdminTemplateId);
	}

	public static NotificationAdminTemplate updateImpl(
		NotificationAdminTemplate notificationAdminTemplate) {

		return getPersistence().updateImpl(notificationAdminTemplate);
	}
	 ...
	 * @throws NoSuchNotificationAdminTemplateException if a notification admin template with the primary key could not be found
	 */
	public static NotificationAdminTemplate findByPrimaryKey(
			long notificationAdminTemplateId)
		throws com.liferay.notification.admin.exception.
			NoSuchNotificationAdminTemplateException {

		return getPersistence().findByPrimaryKey(notificationAdminTemplateId);
	}
	 ...
	 */
	public static NotificationAdminTemplate fetchByPrimaryKey(
		long notificationAdminTemplateId) {

		return getPersistence().fetchByPrimaryKey(notificationAdminTemplateId);
	}
	 ...
	 */
	public static List<NotificationAdminTemplate> findAll() {
	 ...
	 */
	public static List<NotificationAdminTemplate> findAll(int start, int end) {
	...
	public static NotificationAdminTemplatePersistence getPersistence() {
		return _persistence;
	}

	private static volatile NotificationAdminTemplatePersistence _persistence;
