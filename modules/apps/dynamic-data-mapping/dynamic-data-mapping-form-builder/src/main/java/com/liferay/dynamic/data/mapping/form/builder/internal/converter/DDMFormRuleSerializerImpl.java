 ...
 */
@Component(immediate = true, service = DDMFormRuleSerializer.class)
public class DDMFormRuleSerializerImpl implements DDMFormRuleSerializer {
	...
	public String serialize(
		...
		return jsonSerializer.serializeDeep(
			_ddmFormRuleToDDMFormRuleConverter.convert(ddmFormRules));
	}
