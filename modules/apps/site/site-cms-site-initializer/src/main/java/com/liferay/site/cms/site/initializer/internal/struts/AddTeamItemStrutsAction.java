 ...
 */
@Component(property = "path=/cms/add_team_item", service = StrutsAction.class)
public class AddTeamItemStrutsAction implements StrutsAction {
	...
	public String execute(
		...
		objectEntry = objectEntryManager.addObjectEntry(
			...
			ParamUtil.getString(httpServletRequest, "groupId"));
