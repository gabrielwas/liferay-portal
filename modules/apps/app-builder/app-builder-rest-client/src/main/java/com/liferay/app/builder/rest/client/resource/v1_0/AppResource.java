...
public interface AppResource {
	...
	public void putAppDeployment(Long appId, StatusType statusType)
		throws Exception;

	public HttpInvoker.HttpResponse putAppDeploymentHttpResponse(
			Long appId, StatusType statusType)
		throws Exception;
	...
	public static class AppResourceImpl implements AppResource {
		...
		public void putAppDeployment(Long appId, StatusType statusType)
			...
			HttpInvoker.HttpResponse httpResponse =
				putAppDeploymentHttpResponse(appId, statusType);
		...
		public HttpInvoker.HttpResponse putAppDeploymentHttpResponse(
			...
			httpInvoker.body(statusType.toString(), "application/json");
			...
			if (statusType != null) {
				httpInvoker.parameter("statusType", String.valueOf(statusType));
			}
