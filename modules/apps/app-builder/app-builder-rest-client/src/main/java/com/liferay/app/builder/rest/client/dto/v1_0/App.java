...
public class App {
	...
	public void setDeDataLayoutId(Long deDataLayoutId) {
		this.deDataLayoutId = deDataLayoutId;
	}

	public void setDeDataLayoutId(
		UnsafeSupplier<Long, Exception> deDataLayoutIdUnsafeSupplier) {

		try {
			deDataLayoutId = deDataLayoutIdUnsafeSupplier.get();
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	public void setDeDataListViewId(Long deDataListViewId) {
		this.deDataListViewId = deDataListViewId;
	}

	public void setDeDataListViewId(
		UnsafeSupplier<Long, Exception> deDataListViewIdUnsafeSupplier) {

		try {
			deDataListViewId = deDataListViewIdUnsafeSupplier.get();
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	protected Long deDataListViewId;
