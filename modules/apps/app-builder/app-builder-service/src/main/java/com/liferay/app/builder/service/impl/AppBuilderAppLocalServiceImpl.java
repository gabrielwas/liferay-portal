...
public class AppBuilderAppLocalServiceImpl
	...
	public List<AppBuilderApp> getAppBuilderApps(
		...
		return appBuilderAppPersistence.findByG_C(
	...
	@Override
	public int getAppBuilderAppsCount(long groupId, long companyId) {
		return appBuilderAppPersistence.countByG_C(groupId, companyId);
	}
