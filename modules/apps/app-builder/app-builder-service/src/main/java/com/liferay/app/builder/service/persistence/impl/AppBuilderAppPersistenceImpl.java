...
public class AppBuilderAppPersistenceImpl
	...
	/**
	 * Returns all the app builder apps where groupId = &#63; and companyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @return the matching app builder apps
	 */
	@Override
	public List<AppBuilderApp> findByG_C(long groupId, long companyId) {
		return findByG_C(
			groupId, companyId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the app builder apps where groupId = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>AppBuilderAppModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<AppBuilderApp> findByG_C(
	...
	/**
	 * Returns an ordered range of all the app builder apps where groupId = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>AppBuilderAppModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first app builder app in the ordered set where groupId = &#63; and companyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AppBuilderApp findByG_C_First(
			long groupId, long companyId,
			OrderByComparator<AppBuilderApp> orderByComparator)
		throws NoSuchAppException {

		AppBuilderApp appBuilderApp = fetchByG_C_First(
	 ...
	 */
	@Override
	public AppBuilderApp fetchByG_C_First(
		long groupId, long companyId,
		OrderByComparator<AppBuilderApp> orderByComparator) {

		List<AppBuilderApp> list = findByG_C(
	...
	/**
	 * Returns the last app builder app in the ordered set where groupId = &#63; and companyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AppBuilderApp findByG_C_Last(
			long groupId, long companyId,
			OrderByComparator<AppBuilderApp> orderByComparator)
		throws NoSuchAppException {

		AppBuilderApp appBuilderApp = fetchByG_C_Last(
			groupId, companyId, orderByComparator);
	 ...
	 */
	@Override
	public AppBuilderApp fetchByG_C_Last(
		long groupId, long companyId,
		OrderByComparator<AppBuilderApp> orderByComparator) {
	...
	/**
	 * Returns the app builder apps before and after the current app builder app in the ordered set where groupId = &#63; and companyId = &#63;.
	 *
	 * @param appBuilderAppId the primary key of the current app builder app
	 * @param groupId the group ID
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public AppBuilderApp[] findByG_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_C_PrevAndNext(
				session, appBuilderApp, groupId, companyId, orderByComparator,
				true);
	...
	protected AppBuilderApp getByG_C_PrevAndNext(
		Session session, AppBuilderApp appBuilderApp, long groupId,
		long companyId, OrderByComparator<AppBuilderApp> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the app builder apps where groupId = &#63; and companyId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 */
	...
	/**
	 * Returns the number of app builder apps where groupId = &#63; and companyId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param companyId the company ID
	 * @return the number of matching app builder apps
	...
	protected AppBuilderApp getByG_C_D_S_PrevAndNext(
		Session session, AppBuilderApp appBuilderApp, long groupId,
		long companyId, long ddmStructureId, int status,
		OrderByComparator<AppBuilderApp> orderByComparator, boolean previous) {
