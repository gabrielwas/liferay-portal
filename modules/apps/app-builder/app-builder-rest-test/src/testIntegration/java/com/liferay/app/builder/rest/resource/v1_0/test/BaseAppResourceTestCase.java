...
public abstract class BaseAppResourceTestCase {
	...
	protected App testGetSiteAppsPage_addApp(Long siteId, App app)
		...
		return appResource.postSiteApp(siteId, app);
	}
	...
	protected App testPostSiteApp_addApp(App app) throws Exception {
		return appResource.postSiteApp(testGetSiteAppsPage_getSiteId(), app);
	}
	...
	protected void assertValid(App app) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("deDataLayoutId", additionalAssertFieldName)) {
				if (app.getDeDataLayoutId() == null) {
					valid = false;
				}
			...
			if (Objects.equals("deDataListViewId", additionalAssertFieldName)) {
				if (app.getDeDataListViewId() == null) {
					valid = false;
				}
	...
	protected boolean equals(App app1, App app2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("deDataLayoutId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						app1.getDeDataLayoutId(), app2.getDeDataLayoutId())) {
			...
			if (Objects.equals("deDataListViewId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						app1.getDeDataListViewId(),
						app2.getDeDataListViewId())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("deDataLayoutId")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}

		if (entityFieldName.equals("deDataListViewId")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
		...
		return new App() {
			{
				...
				deDataLayoutId = RandomTestUtil.randomLong();
				deDataListViewId = RandomTestUtil.randomLong();
