...
public abstract class BaseAppGraphQLTestCase {
	...
	protected boolean equals(App app, JSONObject jsonObject) {
		...
		for (String fieldName : fieldNames) {
			if (Objects.equals("deDataLayoutId", fieldName)) {
				if (!Objects.equals(
						app.getDeDataLayoutId(),
						(Long)jsonObject.getLong("deDataLayoutId"))) {
			...
			if (Objects.equals("deDataListViewId", fieldName)) {
				if (!Objects.equals(
						app.getDeDataListViewId(),
						(Long)jsonObject.getLong("deDataListViewId"))) {
